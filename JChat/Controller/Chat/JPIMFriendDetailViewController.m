//
//  JPIMFriendDetailViewController.m
//  极光IM
//
...
@interface JPIMFriendDetailViewController () {
    NSArray *_titleArr;
    NSArray *_imgArr;
...
@implementation JPIMFriendDetailViewController
...
{
    if (indexPath.row == 3) {
        static NSString *cellIdentifier = @"JPIMFrIendDetailMessgeCell";
        JPIMFrIendDetailMessgeCell *cell = (JPIMFrIendDetailMessgeCell *)[tableView dequeueReusableCellWithIdentifier:cellIdentifier];
        if (cell == nil) {
            cell = [[[NSBundle mainBundle] loadNibNamed:@"JPIMFrIendDetailMessgeCell" owner:self options:nil] lastObject];
        }
