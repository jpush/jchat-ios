//
//  JPIMDetailsInfoViewController.m
//  
//
...
@interface JPIMDetailsInfoViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation JPIMDetailsInfoViewController
