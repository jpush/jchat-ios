...
@implementation JPIMImgTableViewCell
...
- (void)setCellData :(UIViewController *)controler chatModel :(ChatModel *)chatModel indexPath :(NSIndexPath *)indexPath
{
