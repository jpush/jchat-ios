...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [JPIMMessageTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [JPIMMessageTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [JPIMMessageTextView maxCharactersPerLine]) + 1;
}
