...
/*!
 @abstract JMessage核心头文件。
 @discussion 这是唯一需要导入到你的项目里的头文件，它引用了内部需要用到的头文件。
 */
@interface JMessage : NSObject

/*! JMessage SDK 版本号。用于展示 SDK 的版本信息 */
#define JMESSAGE_VERSION @"1.1.0"
#define JMESSAGE_BUILD   @"460"
...
/*!
 @abstract 设置所有回调delegate

 @param delegate 需要接受回调的对象
 @param conversation 允许为nil,不为nil，只关心该conversation的事件信息.nil时,

 @discussion 用来接受各种回调事件
 */
