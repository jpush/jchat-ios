...
@end
@interface JPIMToolBar : UIView<UITextViewDelegate>
/**
 *  表情button
 */
 ...
 *  文本输入view
 */
@property (weak, nonatomic) IBOutlet JPIMMessageTextView *textView;
...
@property (strong, nonatomic)  RecordAnimationView *recordAnimationView;
