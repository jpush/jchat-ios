...
-(void)setCellData :(ChatModel *)model delegate :(id )delegate indexPath :(NSIndexPath *)indexPath
{
...
-(void)playerVoice
{
    ...
    if ( ! self.playing) {
        ...
        [[XHAudioPlayerHelper shareInstance] setDelegate:(id)self];
        [[XHAudioPlayerHelper shareInstance] managerAudioWithFileName:self.model.voicePath toPlay:YES];
        self.playing = YES;
    }
    else {
        self.playing = NO;
