...
@interface JPIMContactsViewController ()
@property (nonatomic,strong)UISearchDisplayController * searchDisplayController ;

@end
@implementation JPIMContactsViewController
...
{
    JPIMAddViewController *addFriends =[[JPIMAddViewController alloc] init];
