...
@interface JPIMRegisterViewController ()

@end

@implementation JPIMRegisterViewController
    ...
    if (![self.passwordField.text isEqualToString:@""] && ![self.accountField.text isEqualToString:@""]) {
        [JMSGUserManager registerWithUsername:self.accountField.text password:self.passwordField.text completionHandler:^(id resultObject, NSError *error) {
            if (error ==nil) {
                ...
                JPIMRegisterDetailViewController *registerDetail = [[JPIMRegisterDetailViewController alloc] initWithNibName:@"JPIMRegisterDetailViewController" bundle:nil];
