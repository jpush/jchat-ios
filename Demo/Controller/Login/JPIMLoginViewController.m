...
@interface JPIMLoginViewController ()
{
    SInt64 uid;
    BOOL pushFlag;
}
...
@implementation JPIMLoginViewController
...
//    JPIMAlreadyLoginViewController *alreadyLoginCtl = [[JPIMAlreadyLoginViewController alloc] initWithNibName:@"JPIMAlreadyLoginViewController" bundle:nil];
...
- (IBAction)registerBtnClick:(id)sender {
    JPIMRegisterViewController *registerCtl = [[JPIMRegisterViewController alloc] initWithNibName:@"JPIMRegisterViewController" bundle:nil];
