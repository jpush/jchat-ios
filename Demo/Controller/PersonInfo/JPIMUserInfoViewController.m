...
@interface JPIMUserInfoViewController ()
...
@implementation JPIMUserInfoViewController
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    NSString *imgPath = [JPIMFileManager saveImageWithConversationID:user.username andData:UIImageJPEGRepresentation(image, 1)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    JPIMSettingCell *cell = (JPIMSettingCell *)[tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    if (cell == nil) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"JPIMSettingCell" owner:self options:nil] lastObject];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row==1) {
        JPIMSettingViewController *settingCtl =[[JPIMSettingViewController alloc] init];
